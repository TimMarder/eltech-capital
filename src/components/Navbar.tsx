    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <Link
                ...
                className="text-white/80 hover:text-gold-400 font-medium transition-colors relative group"
              >
                {link.label}
            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                <motion.button
                  ...
                  className="flex items-center gap-2 px-4 py-2 border border-white/20 text-white/80 rounded-lg font-medium hover:bg-white/10 hover:text-white transition-colors"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div 
              className="md:hidden py-4 border-t border-gold-500/30"
            ...
            >
              ...
              {user ? (
                <motion.button
                  ...
                  className="block mt-4 w-full px-4 py-2 border border-white/20 text-white/80 rounded-lg font-medium text-center"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
